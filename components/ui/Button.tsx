...
const variants = {
  ...
  // --accent (magenta) é uma cor ESCURA — texto claro (--ink) é o que
  // mantém contraste AA aqui (ao contrário do tema lima anterior).
  accent:
    "bg-accent text-ink shadow-[0_10px_24px_-12px_rgba(var(--accent-glow),0.55)] hover:bg-accent-hover hover:-translate-y-0.5",
};
