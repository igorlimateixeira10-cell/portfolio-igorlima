    ...
    <section id="services" className="border-b border-line bg-bg/80">
      <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
        {/* Painel único envolvendo a seção inteira — a referência trata
            ...
            de cards direto no fundo do site. */}
        <Reveal>
          <div className="tech-panel rounded-4xl p-6 sm:p-10 lg:p-14">
            <SectionHeading
              ...
              {dict.services.items.map((service, i) => {
                ...
                return (
                  <Reveal key={service.title} delay={i * 50} className="h-full">
                    <div className="glow-card tech-card group flex h-full flex-col gap-3 rounded-2xl p-7">
