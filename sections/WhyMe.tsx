...
export function WhyMe({ dict }: { dict: Dictionary }) {
  return (
    <section className="ark-section ark-why-me">
      <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
        <Reveal>
          <span className="font-mono text-xs uppercase tracking-[0.18em] text-accent-ink">
            {dict.whyMe.eyebrow}
          </span>
          <h2 className="mt-3 max-w-2xl text-balance text-4xl font-bold leading-[0.95] tracking-tight text-ink sm:text-5xl lg:text-[3.75rem]">
            {dict.whyMe.title}
          </h2>
        </Reveal>
