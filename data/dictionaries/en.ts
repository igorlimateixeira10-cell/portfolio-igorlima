...
export const en: Dictionary = {
  ...
  hero: {
    ...
    stats: [
      { value: "03", label: "Published projects" },
  ...
  contact: {
    ...
    qrLabel: "Scan me",
    qrHint: "Opens WhatsApp straight on your phone.",
  },
  faq: {
    eyebrow: "FAQ",
    title: "Frequently asked questions",
    // Same as pt.ts — empty until real content is provided; the section
    // stays hidden until then (see sections/FAQ.tsx).
    items: [],
  },
  footer: {
