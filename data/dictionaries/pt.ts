...
export type Dictionary = {
  ...
  hero: {
    ...
    availability: string;
    proof: string;
    /** Pequenos cards de métrica logo abaixo dos CTAs do Hero (ver
     *  sections/Hero.tsx) — exatamente 3 itens, linguagem visual de card
     *  tecnológico (número grande + rótulo curto). */
  ...
  // Perguntas frequentes — a section (sections/FAQ.tsx) só renderiza se
  // `items` tiver pelo menos 1 pergunta real; sem conteúdo verificado
  // aqui, nada aparece no site (ver comentário nos valores abaixo).
  faq: {
    eyebrow: string;
    title: string;
...
export const pt: Dictionary = {
  ...
  hero: {
    ...
    stats: [
      ...
      { value: "SEO", label: "Técnico incluído" },
    ],
  },
  qualify: {
  ...
  contact: {
    ...
    qrLabel: "Escaneie",
    qrHint: "Abre o WhatsApp direto no seu celular.",
  },
  faq: {
    eyebrow: "Dúvidas",
    title: "Perguntas frequentes",
    // TODO(Igor): me passe as perguntas/respostas reais que você quer
    // aqui — nada foi inventado. Enquanto `items` estiver vazio, a
    // section inteira fica oculta (ver sections/FAQ.tsx).
    items: [],
  },
  footer: {
